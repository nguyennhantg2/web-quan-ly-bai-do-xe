                ...
                <div className="customer-rows customerCreate_table">
                    ...
                    <Card className="ant-content-head">
                        ...
                        <div className="flex flex-middle">
                            Tên đơn vị:
                            <div className="ant-content-input-search ml-10 flex flex-middle">
                            <Input
                                placeholder="Tìm đơn vị"
                                value={dataSearch}
                                onChange={(e) => onChangeFilter(e.target.value)}
                                className="input-search"/>
                            <button className="btn-find mr-10 ml-10" style={{width: 100}}>Bộ lọc</button>
                            <button className="btn-search" style={{width: 150}}>Tìm kiếm</button>
                            </div>
                        </div>
                        </div>
